...
public class TblProveedor implements Serializable {
	...
	public String getRucpoveedor() {
		return this.rucpoveedor;
	}

	public void setRucpoveedor(String rucpoveedor) {
		this.rucpoveedor = rucpoveedor;
	}
